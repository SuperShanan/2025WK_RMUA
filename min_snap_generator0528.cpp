...
// std::vector<Eigen::Vector3d> original{{4.0, 2.2, 1.5},{8.0, 2.6, 1.8},{18.1, 2.7 ,3.5},{23, 5.0, 3.5},{18.1, 8.0, 3.5},{10.3, 5.0, 2.1},{21.8, 2.2, 1.5},{21, 7.8, 1.5},{11, 7.8, 1.50},{8.5, 7.8, 1.5},{4, 7.8, 1.0}};
// std::vector<Eigen::Vector3d> list_original{{2.0, 2.2, 1.5},
//                                             {6.0, 2.6, 1.8},
//                                             {15, 2.7, 3.5},{18.1, 2.7 ,3.5},
//                                             {23, 3, 3.5},{23, 5.0, 3.5},
//                                             {20, 8, 3.5},{18.1, 8.0, 3.5},
//                                             {11, 7.8, 2.25},{10.8,7.5,2.1},{10.5, 7, 2.1},{10.3, 5.0, 2.1},
//                                             {20, 2.2, 1.5},{21.8, 2.2, 1.5},
//                                             {22, 7.8, 1.5},{21, 7.8, 1.5},
//                                             {13, 7.8, 1.5},{11, 7.8, 1.50},{8.5, 7.8, 1.5},{4, 7.8, 1.0}};

// std::vector<Eigen::Vector3d> list_original{{2.0, 2.2, 1.5},     //1号
//                                             {6.0, 2.6, 1.8},    //2号
//                                             {12, 2.7, 3.5},{15, 2.7, 3.5},  //3号
//                                             {23, 3, 3.5},{23.1 , 3.5, 3.5},     //4号
//                                             {23, 8, 3.5},{20, 8, 3.5},   //5号
//                                             {11, 7.8, 2.25},{10.8,7.5,2.1},{10.5, 7, 2.1},  //6号
//                                             {20, 2.2, 1.5},     //7号
//                                             {22, 7.8, 1.5},     //8号
//                                             {13, 7.8, 1.5},     //9号
//                                             {11, 7.8, 1.50},    //10号
...
std::vector<Eigen::Vector3d> list_original{{3.35, 0, 1.5},     //1号
                                            {7.08, 0.25, 1.7},    //2号
                                            {12, 0.93, 3.10},{14.4, 0.93, 3.11},  //3号
                                            {21.8, -0.85, 3.13},{22, -0.16, 3.13},     //4号
                                            {20.5, 5.2, 3.39},{19.7, 5.4, 3.39},   //5号
                                            {15, 4.2, 2.9},{11.2, 7.75, 1.3},{9.5, 6.48, 1.34},{9.40, 6.08, 1.34},  //6号
                                            {20, 2.2, 1.5},     //7号???
                                            {22, 7.8, 1.5},     //8号
                                            {13, 7.8, 1.5},     //9号
                                            {11, 7.8, 1.50},    //10号
...
int stop[10] = {3,5,7,11,12,13,17};    //需要重归划的点的下标，会停下的点下标
...
{   
    ...
    if(duandian_index==0||duandian_index==4)
    {
        lst_replan[0] = visual_point_position[0]+0.7;
        lst_replan[1] = visual_point_position[1]-0.1;
        lst_replan[2] = visual_point_position[2];
        mean_vel = 0.8;
    }
    if(duandian_index==2||duandian_index==5||duandian_index==6)
    {
